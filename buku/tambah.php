...
if ($_POST) {
    ...
    $query = "INSERT INTO buku (judul, penulis, penerbit, tahun_terbit, isbn, kategori, jumlah_halaman, stok) 
              VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
    $stmt = $db->prepare($query);
    if ($stmt->execute([$judul, $penulis, $penerbit, $tahun_terbit, $isbn, $kategori, $jumlah_halaman, $stok])) {
        header("Location: index.php?message=Buku berhasil ditambahkan");
        exit();
    } else {
